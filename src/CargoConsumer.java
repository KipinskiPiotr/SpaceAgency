...
public class CargoConsumer extends DefaultConsumer {
    private Channel channel;
    private final String EXCHANGE_NAME;

    public CargoConsumer(Channel channel, String exchangeName) {
        super(channel);
    ...
    public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
        ...
        System.out.println("Received cargo order " + ORDER_ID + " from Agency " + AGENCY_ID);
